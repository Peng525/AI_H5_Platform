...
app.include_router(deck_ppt_templates.router)
...
if STATIC_DIR.exists():
    ...
    resume_tpl_dir = STATIC_DIR / "resume-templates"
    if resume_tpl_dir.is_dir():
        app.mount("/resume-templates", StaticFiles(directory=resume_tpl_dir), name="resume_templates")

    deck_tpl_dir = STATIC_DIR / "deck-templates"
    if deck_tpl_dir.is_dir():
        app.mount("/deck-templates", StaticFiles(directory=deck_tpl_dir), name="deck_templates")
