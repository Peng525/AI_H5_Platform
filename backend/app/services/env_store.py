...
ENV_TO_FIELD: dict[str, str] = {
    ...
    "LLM_RELAY_BASE_URL": "llm_relay_base_url",
    "LLM_RELAY_API_KEY": "llm_relay_api_key",
    "LLM_RELAY_MODEL": "llm_relay_model",
    "LLM_OFFICIAL_BASE_URL": "llm_official_base_url",
    "LLM_OFFICIAL_API_KEY": "llm_official_api_key",
    "LLM_OFFICIAL_MODEL": "llm_official_model",
