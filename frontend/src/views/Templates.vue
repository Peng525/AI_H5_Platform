<template>
  <div class="min-h-screen bg-background flex flex-col">
    ...
    <div class="max-w-7xl mx-auto p-6 md:p-10 flex-1 w-full">
      ...
      <p v-if="loading" class="text-on-surface-variant text-sm py-8">加载模板中…</p>
      ...
      <div v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="h-36 bg-gradient-to-br overflow-hidden relative" :class="t.cover_gradient">
            ...
            <span
              class="absolute top-2 left-2 text-[10px] px-2 py-0.5 rounded-full bg-black/40 text-white inline-flex items-center gap-0.5"
            >
...
onMounted(async () => {
  ...
  const cats = await api.getTemplateCategories()
