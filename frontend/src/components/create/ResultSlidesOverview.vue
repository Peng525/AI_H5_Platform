      ...
      <template v-for="(slide, index) in slides" :key="slide.id">
        <div class="relative shrink-0">
          <section
            ...
            class="rounded-xl border-2 overflow-hidden transition-colors duration-300 cursor-pointer"
            :style="{
        ...
        <div
          ...
          :class="isGeneratePanelOpen(slide.id) ? 'overflow-visible z-10' : 'overflow-visible'"
          :style="gapSpacerStyle()"
        ...
        >
          <template v-if="showInsertUi && isInsertSlotVisible(index, slide)">
            <div
              ...
              :class="isGeneratePanelOpen(slide.id) ? '' : 'overflow-hidden'"
            >
            ...
            <div
              ...
              class="absolute left-0 right-0 top-full z-20 mt-2 rounded-2xl bg-gradient-to-b from-[#0f1a2e] via-[#1e3a6b] to-[#3a8fd4] px-5 sm:px-6 py-5 overflow-visible pointer-events-auto"
            >
              <GenerateCardPanel
