...
const routes = [
  { path: '/login', name: 'login', component: () => import('../views/Login.vue'), meta: { title: '登录', public: true } },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '个人简历', workbenchSection: 'resumes' },
      },
    ],
  },
  ...
  { path: '/create/generate/resume/:publicId', name: 'ai-resume-workspace', component: () => import('../views/create/AiResumeWorkspace.vue'), meta: { title: '简历优化', requiresAuth: true } },
